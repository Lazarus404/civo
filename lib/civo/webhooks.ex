defmodule Civo.WebHooks do
  @moduledoc """
  Open certain actions taking place within your account, we can 
  ...
  X-Civo-Event is a UUID that is unique to this event. We don't track 
  ...
  OpenSSL HMAC SHA1 digest of the entire payload using either the 
  ...
  to calculate this in Ruby would be:
